...
export default async function PublicationsPage({
  ...
  <section className="mt-8 bg-white border border-stone-200 rounded-lg overflow-hidden">
      ...
      return (
        <Link
          ...
          className={`group block border-b border-stone-200 last:border-b-0 transition-colors ${
            alternate ? 'bg-stone-100 hover:bg-stone-200' : 'bg-white hover:bg-stone-200'
          }`}
        >
